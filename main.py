...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174",'https://lumina-ai-bblg50n87-chinni-kesana-s-projects.vercel.app','lumina-ai-ui-delta.vercel.app'],  # Add your frontend URLs
